...
@CucumberOptions(features = "classpath:feature", // we provide path of feature folder
		...
		tags = "@Comparison", // with tags we will run our test cases
		...
		plugin = { "pretty", "html:target/site/cucumber-pretty", "json:target/cucumber.json" }, publish = true // this
																												// will
						//Interview Q: how to handle stale element exception? 																						// generate
						//HTML element depreciated																						// execution
																												// report
)
